...
public class Shorebreak_Store{
    @Test(priority = 13)
    public void ShoreBreakStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://shorebreak.orderapp.online/Index?OrderType=3";
        ...
        String DesiredCheckoutPageURL = "https://shorebreak.orderapp.online/Checkout";
        ...
        if (ActualStatus) {
            ...
            Assert.fail(" ShoreBreak is offline : So the test case is FAIL");
