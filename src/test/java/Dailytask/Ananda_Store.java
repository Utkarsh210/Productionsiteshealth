...
public class Ananda_Store{

    @Test(priority = 2)
    public void AnandaStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://ananda.orderapp.online/Index?OrderType=2";
        ...
        String DesiredCheckoutPageURL = "https://ananda.orderapp.online/Checkout";
