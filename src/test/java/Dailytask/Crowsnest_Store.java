...
public class Crowsnest_Store{

    @Test(priority = 5)
    public void CrowsenestStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://crowsnest.orderapp.online/Index?OrderType=3";
        ...
        String DesiredCheckoutPageURL = "https://crowsnest.orderapp.online/Checkout";
        ...
        if (ActualStatus) {
            ...
            System.out.println("Crowsnet Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" Crowsnet Store is offline : So the test case is FAIL");
