...
public class Countrypizza_Store{


    @Test(priority = 4)
    public void CountryPizzaStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://cnpizza.orderapp.online/Index?OrderType=4";
        ...
        String DesiredCheckoutPageURL = "https://cnpizza.orderapp.online/Checkout";
