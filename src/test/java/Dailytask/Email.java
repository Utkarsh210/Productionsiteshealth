...
public class Email{
    ...
    public void Send_update() throws InterruptedException, EmailException {
        ...
        final String username = "info@techryde.com";  // like yourname@outlook.com
        final String password = "!nf0Pass@20";   // password here
        ...
        Session session = Session.getInstance(props, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("info@techryde.com", "!nf0Pass@20");
            }
        });
        ...
        try {
            ...
            messageBodyPart1.setText("Hi Team, Store online status has been checked for today and please find the stores which are online and offline");
