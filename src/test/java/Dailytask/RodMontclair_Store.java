...
public class RodMontclair_Store {

    @Test(priority = 26)
    public void RodMontclairStoreStatus() throws InterruptedException {
        ...
        js3.executeScript("arguments[0].scrollIntoView();", driver.findElement(By.id("orderstore8")));


        Thread.sleep(9000);
        driver.findElement(By.id("orderstore8")).click();
        ...
        if (ActualStatus) {
            ...
            System.out.println("rod Montclair Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" rod Montclair Store is offline : So the test case is FAIL");
