...
public class Cosmos_Store{


    @Test(priority = 3)
    public void CosmosStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://cosmos.orderapp.online/Index?OrderType=29";
        ...
        String DesiredCheckoutPageURL = "https://cosmos.orderapp.online/Checkout";
