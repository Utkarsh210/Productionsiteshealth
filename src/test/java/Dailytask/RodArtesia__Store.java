...
public class RodArtesia__Store {
    @Test(priority = 23)
    public void RodArtesiaStoreStatus() throws InterruptedException {
...
*/
        ...
        if (ActualStatus) {
            ...
            System.out.println("Artesi Store is online: So the Test case is  PASS");
        } else {


            Assert.fail("  Artesia Store is offline : So the test case is FAIL");
