...
public class WeatherGage_Store {



    @Test(priority = 32)
    public void WeatherGageStoreStatus() throws InterruptedException {
        ...
        driver.get("https://weathergage.orderapp.online");
 ...
 */
        ...
        String DesiredURL = "https://weathergage.orderapp.online/Index?OrderType=2";
        ...
        if (AllItemOnIndexPage.size() == 0) {
           ...
           // driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[10]/div/div/div[3]/button")).click();
        ...
        String DesiredCheckoutPageURL = "https://weathergage.orderapp.online/Checkout";
        ...
        if (ActualStatus) {
            ...
            System.out.println("WeatherGage Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" WeatherGage Store is offline : So the test case is FAIL");
