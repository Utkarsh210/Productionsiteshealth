...
public class Villagebowl_Store{

    @Test(priority = 16)
    public void VillageBowlStoreStatus() throws InterruptedException {
        ...
        String  DesiredURL= "https://villagebowl.orderapp.online/Index?OrderType=4";
        ...
        String DesiredCheckoutPageURL = "https://villagebowl.orderapp.online/Checkout";
