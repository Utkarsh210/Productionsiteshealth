...
public class Ndasia_Store{



    @Test(priority = 11)
    public void NdasiaStoreStatus() throws InterruptedException {
        ...
        String  DesiredURL= "https://ndasia.orderapp.online/Index?OrderType=2";
        ...
        if(AllItemOnIndexPage.size()==0){
            ...
            WebElement FirstItem = AllItemOnIndexPage.get(47);
            ((WebElement) FirstItem).click();

            Thread.sleep(3000);

            driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[51]/div/div/div[3]/button")).click();
        ...
        String DesiredCheckoutPageURL = "https://ndasia.orderapp.online/Checkout";
        ...
        if (ActualStatus) {
            ...
            System.out.println("Ndasia Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" Ndasia Store is offline : So the test case is FAIL");
