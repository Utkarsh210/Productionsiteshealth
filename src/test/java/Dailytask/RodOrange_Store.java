...
public class RodOrange_Store {


    @Test(priority = 27)
    public void RodOrangeStoreStatus() throws InterruptedException {
        ...
        js3.executeScript("arguments[0].scrollIntoView();", driver.findElement(By.id("orderstore1")));
        ...
        if (ActualStatus) {
            ...
            System.out.println("rod Orange Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" rod Orange Store is offline : So the test case is FAIL");
