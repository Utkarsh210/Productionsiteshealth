...
public class RodHuntingtonBeach_Store {
    @Test(priority = 25)
    public void RodHuntingtonBeachStoreStatus() throws InterruptedException {
        ...
        js3.executeScript("arguments[0].scrollIntoView();", driver.findElement(By.id("orderstore7")));


        Thread.sleep(9000);
        driver.findElement(By.id("orderstore7")).click();
        ...
        if (ActualStatus) {
            ...
            System.out.println("rod HuntingTownBeach Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" rod HuntingTownBeach Store is offline : So the test case is FAIL");
