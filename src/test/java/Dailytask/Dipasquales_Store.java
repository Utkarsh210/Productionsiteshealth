...
public class Dipasquales_Store{

    @Test(priority = 7)
    public void DipasqualesStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://dipasquales.orderapp.online/Index?OrderType=5";
        ...
        if(ActualUrl) {
            ...
            driver.findElement(By.id("orderstore5")).click();
...
*/
        ...
        if (AllItemOnIndexPage.size() == 0) {
            ...
            WebElement FirstItem = AllItemOnIndexPage.get(92);
            ((WebElement) FirstItem).click();

            Thread.sleep(3000);

            driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[97]/div/div/div[3]/button")).click();
        ...
        boolean SignInModal = driver.findElement(By.xpath("//*[@id=\"CheckoutloginModal\"]/div/div/div[2]/form/div[1]/a[3]")).isDisplayed();
        ...
        String DesiredCheckoutPageURL = "https://dipasquales.orderapp.online/Checkout";
        ...
        if (ActualStatus) {
            ...
            System.out.println("Dipasquales Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" Dipasquales Store is offline : So the test case is FAIL");
