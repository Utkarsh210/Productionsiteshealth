...
public class H2Ocean_Store{


    @Test(priority = 8)
    public void H2OceanStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://h2ocean.orderapp.online/Index?OrderType=3";
        ...
        if (AllItemOnIndexPage.size() == 0) {
            ...
            WebElement FirstItem = AllItemOnIndexPage.get(2);
            ((WebElement) FirstItem).click();

            Thread.sleep(3000);

            driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[7]/div/div/div[3]/button")).click();
        ...
        String DesiredCheckoutPageURL = "https://h2ocean.orderapp.online/Checkout";
