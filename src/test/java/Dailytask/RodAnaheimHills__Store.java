...
public class RodAnaheimHills__Store {
    @Test(priority = 22)
    public void RodAnaheimHillsStoreStatus() throws InterruptedException {
        ...
        driver.findElement((By.id("orderstore4"))).click();
...
*/
        ...
        if (ActualStatus) {
            ...
            System.out.println("AnaheimHills Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" AnaheimHills Store is offline : So the test case is FAIL");
