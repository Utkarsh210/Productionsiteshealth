...
public class Shoyou_Store{

    @Test(priority = 14)
    public void ShoyouStoreStatus() throws InterruptedException {
        ...
        String  DesiredURL= "https://shoyou.orderapp.online/Index?OrderType=2";
        ...
        if (ActualUrl!=true){
            ...
            Assert.fail("Shoyou Store is currently offline so the test case got failed");
        }
        /*
        if(ActualUrl) {
...
*/
        ...
        List<WebElement> timeslots = driver.findElements(By.xpath("//a[contains(@id,'modal')] | //*[@id=\"selectdate\"]/div/div/div/div/ul[2]/li"));  //Select Asap
        ...
        String DesiredCheckoutPageURL = "https://shoyou.orderapp.online/Checkout";
