...
public class Aldos_Store{

    @Test(priority = 1)
    public void AldosStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://aldos.orderapp.online/Index?OrderType=3";
        ...
        if (AllItemOnIndexPage.size() == 0) {
            ...
            WebElement FirstItem = AllItemOnIndexPage.get(6);
            ((WebElement) FirstItem).click();

            Thread.sleep(3000);

            driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[11]/div/div/div[3]/button")).click();
...
*/
        ...
        String DesiredCheckoutPageURL = "https://aldos.orderapp.online/Checkout";
        ...
        if (ActualStatus) {
            ...
            System.out.println("Aldos Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" Aldos Store is offline : So the test case is FAIL");
