...
public class Ventura_Store{


    @Test(priority = 15)
    public void VenturaStoreStatus() throws InterruptedException {
        ...
        String  DesiredURL= "https://ventura.orderapp.online/Index?OrderType=3";
        ...
        if(AllItemOnIndexPage.size()==0){
            ...
            driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[5]/div/div/div[3]/button")).click();
        ...
        String DesiredCheckoutPageURL = "https://ventura.orderapp.online/Checkout";
