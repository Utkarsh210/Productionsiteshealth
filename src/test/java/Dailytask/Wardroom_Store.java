...
public class Wardroom_Store{



    //  WebDriver driver;
    @Test(priority = 17)
    public void WardroomStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://wardroom.techryde.com/Index?OrderType=27";
        ...
        String DesiredCheckoutPageURL = "https://wardroom.techryde.com/Checkout";
