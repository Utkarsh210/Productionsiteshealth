...
public class RodRiverSide_Store {


    @Test(priority = 28)
    public void RodRiverSideStoreStatus() throws InterruptedException {
        ...
        js3.executeScript("arguments[0].scrollIntoView();", driver.findElement(By.id("orderstore9")));


        Thread.sleep(9000);
        driver.findElement(By.id("orderstore9")).click();
        ...
        if (ActualStatus) {
            ...
            System.out.println("rod RiverSide Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" rod RiverSide Store is offline : So the test case is FAIL");
