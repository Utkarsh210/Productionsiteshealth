...
public class RodCorona_Store {
    @Test(priority = 24)
    public void RodCoronaStoreStatus() throws InterruptedException {
        ...
        js3.executeScript("arguments[0].scrollIntoView();", driver.findElement(By.id("orderstore6")));


        Thread.sleep(9000);
        driver.findElement(By.id("orderstore6")).click();
...
*/
        ...
        if (ActualStatus) {
            ...
            System.out.println("rodrigos Store is online: So the Test case is  PASS");
        } else {


         Assert.fail(" rodrigos Store is offline : So the test case is FAIL");
