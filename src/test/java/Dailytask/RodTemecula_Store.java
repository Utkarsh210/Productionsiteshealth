...
public class RodTemecula_Store {

    @Test(priority = 29)
    public void RodTemeculaStoreStatus() throws InterruptedException {
        ...
        js3.executeScript("arguments[0].scrollIntoView();", driver.findElement(By.id("orderstore3")));


        Thread.sleep(9000);
        driver.findElement(By.id("orderstore3")).click();
        ...
        if (AllItemOnIndexPage.size() == 0) {
            ...
            WebElement FirstItem = AllItemOnIndexPage.get(62);
            ...
            AddtoCart.get(61).click();

          //  driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[67]/div/div/div[3]/button")).click();
        ...
        if (ActualStatus) {
            ...
            System.out.println("rod Temecula Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" rod Temecual Store is offline : So the test case is FAIL");
