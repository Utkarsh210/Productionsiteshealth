...
public class Jcbean_Store{

    @Test(priority = 10)
    public void JcbeansStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://jcbeans.orderapp.online/Index?OrderType=2";
        ...
        if (AllItemOnIndexPage.size() == 0) {
            ...
            WebElement FirstItem = AllItemOnIndexPage.get(36);
            ((WebElement) FirstItem).click();

            Thread.sleep(3000);

            driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[41]/div/div/div[3]/button")).click();
        ...
        String DesiredCheckoutPageURL = "https://jcbeans.orderapp.online/Checkout";
