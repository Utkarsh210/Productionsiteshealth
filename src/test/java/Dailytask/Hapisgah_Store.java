...
public class Hapisgah_Store{



    @Test(priority = 9)
    public void HapisgahStoreStatus() throws InterruptedException {
        ...
        String DesiredURL = "https://hapisgah.orderapp.online/Index?OrderType=3";
        ...
        if (AllItemOnIndexPage.size() == 0) {
            ...
            WebElement FirstItem = AllItemOnIndexPage.get(13);
            ((WebElement) FirstItem).click();

            Thread.sleep(3000);

            driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[18]/div/div/div[3]/button")).click();
        ...
        String DesiredCheckoutPageURL = "https://hapisgah.orderapp.online/Checkout";
        ...
        if (ActualStatus) {
            ...
            System.out.println("Happisgah Store is online: So the Test case is  PASS");
        } else {


            Assert.fail(" Happisgah Store is offline : So the test case is FAIL");
